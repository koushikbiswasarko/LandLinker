...
<div class="container">
  <div class="section-head">
    ...
    <a class="btn btn-outline" href="<?= url('pages/subscription.php') ?>">View Pricing</a>
  </div>
  ...
  <section class="about-grid">
    ...
    <article class="card about-card">
      ...
      <a class="btn btn-primary" style="margin-top: 12px;" href="<?= url('pages/login.php') ?>">Sign In</a>
    </article>
  </section>
  ...
  <section class="card about-cta">
    ...
    <a class="btn btn-primary" href="<?= url('pages/signup.php') ?>">Create Account</a>
  </section>
</div>
