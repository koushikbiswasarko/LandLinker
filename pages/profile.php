...
if (!$user) { logout_user(); redirect(url('pages/login.php')); }
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if ($first === '' || $last === '') $errors[] = "First name and surname required.";
...
<div class="container">
  ...
  <div class="grid" style="display:grid; grid-template-columns:1fr 1fr; gap:14px;">
    ...
    <div class="card" style="padding:16px;">
      ...
      <?php endif; ?>
      <a class="btn btn-outline" href="<?= url('pages/subscription.php') ?>">Manage subscription</a>
    </div>
  </div>
  ...
  <form class="card" method="post" style="padding:16px; margin-top:10px;">
    ...
    <div style="margin-top:12px;">
      ...
      <a class="btn btn-outline" href="<?= url('pages/logout.php') ?>">Logout</a>
    </div>
  </form>
</div>
