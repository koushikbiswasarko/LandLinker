...
<div class="container">
  <div style="display:flex; justify-content:space-between; align-items:center; gap:10px; flex-wrap:wrap;">
    ...
    <?php if ($isAdmin): ?>
      <div style="display:flex; gap:8px; flex-wrap:wrap;">
        <a class="btn btn-outline" href="<?= url('pages/admin-dashboard.php') ?>">Admin Dashboard</a>
        <a class="btn btn-outline" href="<?= url('pages/admin/deals.php') ?>">Deals</a>
        <a class="btn btn-outline" href="<?= url('pages/admin/payments.php') ?>">Payments</a>
      </div>
    <?php elseif ($isMgr): ?>
      <div style="display:flex; gap:8px; flex-wrap:wrap;">
        <a class="btn btn-outline" href="<?= url('pages/manager-dashboard.php') ?>">Manager Dashboard</a>
        <a class="btn btn-outline" href="<?= url('pages/employee-tasks.php') ?>">Activities</a>
      </div>
    <?php elseif ($isLogged): ?>
      <div style="display:flex; gap:8px; flex-wrap:wrap;">
        <a class="btn btn-outline" href="<?= url('pages/my-properties.php') ?>">My Properties</a>
        <a class="btn btn-outline" href="<?= url('pages/subscription.php') ?>">Upgrade Plan</a>
      </div>
    <?php else: ?>
      <a class="btn btn-outline" href="<?= url('pages/login.php') ?>">Sign in to see your stats</a>
    <?php endif; ?>
  </div>
  ...
  <div class="card" style="padding:14px; margin-top:14px;">
    ...
    <div style="display:flex; gap:10px; flex-wrap:wrap;">
      <a class="btn btn-primary" href="<?= url('pages/map-view.php') ?>">Open Map View</a>

      <?php if ($isLogged): ?>
        <a class="btn btn-outline" href="<?= url('pages/my-properties.php') ?>">My Properties</a>
        <a class="btn btn-outline" href="<?= url('pages/property-create.php') ?>">Add Property</a>
      <?php endif; ?>

      <?php if ($isAdmin): ?>
        <a class="btn btn-outline" href="<?= url('pages/admin/users.php') ?>">Manage Users</a>
        <a class="btn btn-outline" href="<?= url('pages/admin/properties.php') ?>">Manage Properties</a>
      <?php endif; ?>
    </div>
  </div>
</div>
