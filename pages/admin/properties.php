      ...
      <tbody>
        <?php foreach ($rows as $p): ?>
          <tr style="border-top:1px solid rgba(255,255,255,0.08);">
            ...
            <td><?= e($p['status']) ?></td>
            <td>
              <a class="btn btn-outline" href="<?= url('pages/admin/property-edit.php?id=' . (int)$p['id']) ?>">Edit</a>
              <a class="btn btn-outline" href="<?= url('pages/admin/property-delete.php?id=' . (int)$p['id']) ?>">Delete</a>
              <a class="btn btn-primary" href="<?= url('pages/property-details.php?id=' . (int)$p['id']) ?>">View</a>
            </td>
          </tr>
        <?php endforeach; ?>
