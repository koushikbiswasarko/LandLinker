...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if ($data['title']==='' || $data['price_bdt']<=0) $errors[]="Title and price required.";

  if (!$errors) {
    db_update_property($conn, $id, (int)$prop['owner_user_id'], $data, true);
    flash_set('success', 'Property updated.');
    redirect(url('pages/admin/properties.php'));
  }
}
...
<div class="container">
  ...
  <form class="card" method="post" style="padding:16px; margin-top:12px;">
    ...
    <div style="margin-top:12px;">
      ...
      <a class="btn btn-outline" href="<?= url('pages/admin/properties.php') ?>">Cancel</a>
    </div>
  </form>
</div>
