<?php
  ...
  include __DIR__ . '/../includes/dashboard-start-admin.php';
?>
...
<div class="dash-grid">
  <div class="dash-card card">
    <div class="dash-card__head">
      ...
      <div class="segmented" role="tablist" aria-label="Traffic range">
    ...
    <!-- Simple bar chart -->
    <div class="bar-chart" aria-label="Traffic bar chart">
...
<div class="dash-card card" style="margin-top:14px;">
  <div class="dash-card__head">
    <div>
      <h3 class="dash-h3">Recommendations</h3>
      <p class="dash-note">Next actions to improve listing performance</p>
    </div>
    <a class="btn btn-outline" href="<?= url('pages/subscription.php') ?>">Boost with Pro</a>
  </div>

  <div class="dash-list">
    <div class="dash-item">
      <div class="dash-item__dot" aria-hidden="true"></div>
      <div>
